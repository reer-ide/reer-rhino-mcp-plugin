...
namespace ReerRhinoMCPPlugin.UI.Windows
{
    ...
    public partial class MCPControlPanel : Window
    {
        ...
        public MCPControlPanel(ReerRhinoMCPPlugin plugin)
        {
            try
            {
                InitializeComponent();
                ...
                Logger.Info("[DEBUG] MCPControlPanel initialized successfully");
            }
            catch (Exception ex)
            {
                Logger.Error($"[ERROR] MCPControlPanel constructor exception: {ex}");
            }
        }
        ...
        protected override void OnClosed(EventArgs e)
        {
            ...
            {
                _viewModel?.Dispose();
                Logger.Info("[DEBUG] MCPControlPanel closed and disposed");
            }
            catch (Exception ex)
            {
